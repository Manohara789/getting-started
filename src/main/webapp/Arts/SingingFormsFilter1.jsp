...
<body onload="loadEvents()">
	<h3>Details Of Singing Forms </h3>
	 <p>Select Event: <select id="sfs" onchange="readSingingFormsEventsById()" style="height:24px"></select> </p> 
...
function loadEvents() 
{
	...
	xhtml.send();
	var E = document.getElementById("sfs");
	xhtml.onreadystatechange = function()
	{
		if(this.readyState == 4 && this.status == 200)
		{
			...
			for(var x in data)
			{
				...
				/* option.text = data[x].background_behind_it_existence;
				option.text = data[x].instrument_can_be_used_for_it; */  
				option.text = data[x].nameOfRaga;
