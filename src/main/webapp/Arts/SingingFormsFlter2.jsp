...
<body onload="loadEvents()">
	<h3>Details Of Singing Forms </h3>
	 <p>Select Event: <select id="sfs1" onchange="readSingingFormsEventsById()" style="height:24px"></select> </p> 
...
function loadEvents() 
{
	...
	xhtml.send();
	var E = document.getElementById("sfs1");
	xhtml.onreadystatechange = function()
	{
		if(this.readyState == 4 && this.status == 200)
		{
			...
			for(var x in data)
			{
				...
				option.text = data[x].backgroundBehindItExistence;
